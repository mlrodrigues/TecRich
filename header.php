...
<div id="header">
    <h1><a href="user/dashboard.php">TecRich Panel</a></h1>
</div>
    ...
    <ul class="nav">
        <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i> <span class="text"><?php echo $_SESSION['usuarionome']?></span><b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><a href="./user/perfil_user.php"><i class="icon-user"></i> Minha Conta</a></li><li class="divider"></li>
            </ul>
        </li>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        <li><a href="./user/dashboard.php"><i class="icon icon-home"></i> <span>Dashboard</span></a></li>
        <li><a href="./user/graficos.php"><i class="icon icon-signal"></i> <span>Graficos</span></a></li>
