...
<body>
<div id="loginbox">
    <form id="loginform" class="form-vertical" method="post" action="inserir_pro.php">
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <div class="main_input_box">
                    <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="text" placeholder="Profissão" name="profissao" required  />
                </div>
                <div class="main_input_box">
                    <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="tel" placeholder="Telefone" name="telefone" required  />
                </div>
                <div class="main_input_box">
                    <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="tel" placeholder="Celular" name="celular" required  />
                </div>
            </div>
        </div>
